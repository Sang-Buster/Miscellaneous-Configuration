...
1. Go to your RStudio installation path, find the folder named `themes` , folder path may differ depending on your OS. (i.e., in Windows, the default path is `C:\Program Files\RStudio\resources\themes`)
